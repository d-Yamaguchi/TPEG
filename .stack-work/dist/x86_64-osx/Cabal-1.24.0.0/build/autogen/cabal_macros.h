...
/* package TPEG-0.1.0.0 */
#define VERSION_TPEG "0.1.0.0"
#define MIN_VERSION_TPEG(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "TPEG-0.1.0.0-L62dHqUd5CwGyazUa5HUMt"

#define CURRENT_PACKAGE_KEY "TPEG-0.1.0.0-L62dHqUd5CwGyazUa5HUMt"
